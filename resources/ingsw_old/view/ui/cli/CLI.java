...
import it.polimi.ingsw_old.view.ui.UI;
...
public class CLI implements UI {
    ...
    public void execute(String key) throws it.polimi.ingsw_old.exceptions.UnknownCommandException {
    ...
    @Override
    public it.polimi.ingsw_old.network.auth_data.AuthData requestAuth(){
        it.polimi.ingsw_old.network.auth_data.AuthData authData = null;
        ...
        do{
            ...
            if(choice.equalsIgnoreCase("J")) {
                ...
                authData = it.polimi.ingsw_old.network.auth_data.AuthData.joinLobby(playerUsername, lobbyToJoin);
            }
