...
import it.polimi.ingsw_old.model.player_board.faith_path.FaithPath;
import it.polimi.ingsw_old.data.DevelopmentCardsBuilder;
import it.polimi.ingsw_old.data.LeaderCardsBuilder;
import it.polimi.ingsw_old.data.MarbleMarketBuilder;
...
public class TestParser
{
    public static void main( String[] args )
    {
        ...
        it.polimi.ingsw_old.data.MarbleMarketBuilder marbleMarketBuilder = new it.polimi.ingsw_old.data.MarbleMarketBuilder();    // First of all, create a new MarbleMarketBuilder() object
        ...
        it.polimi.ingsw_old.data.MarbleMarketBuilder anotherBuilder = new MarbleMarketBuilder();
