...
import it.polimi.ingsw_old.exceptions.FullLobbyException;
import it.polimi.ingsw_old.exceptions.InvalidLobbyException;
    ...
    public void run() {
        ...
        try {
            ...
            do{
                ...
                it.polimi.ingsw_old.network.auth_data.AuthData authData = (AuthData) in.readObject();
