package it.polimi.ingsw_old.model.player_board;
...
import it.polimi.ingsw_old.exceptions.EmptyDeckException;
...
public class LeaderCardsDeck extends Observable<Update> {
    ...
    public LeaderCard pop(){
        if(leaderCards.isEmpty()) throw new it.polimi.ingsw_old.exceptions.EmptyDeckException("This player's leader cards deck is empty.");
