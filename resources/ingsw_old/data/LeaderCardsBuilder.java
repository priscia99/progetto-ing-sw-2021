package it.polimi.ingsw_old.data;
...
import it.polimi.ingsw_old.model.card.color.ColorPile;
import it.polimi.ingsw.model.card.effect.*;
import it.polimi.ingsw_old.model.card.requirement.ColorRequirement;
import it.polimi.ingsw_old.model.card.requirement.LevelRequirement;
import it.polimi.ingsw_old.model.card.requirement.Requirement;
import it.polimi.ingsw_old.model.card.requirement.ResourceRequirement;
import it.polimi.ingsw_old.model.resource.ResourceStock;
import it.polimi.ingsw_old.model.resource.ResourceType;
import it.polimi.ingsw_old.model.card.effect.*;
...
public class LeaderCardsBuilder{
    ...
    static private void initBuilder() throws IllegalArgumentException{
        try {
            ...
            it.polimi.ingsw_old.utils.CustomLogger.getLogger().info(String.format(("Starting leader cards parsing from file %s"), leaderCardsPath));
            Gson gson = new Gson();
            ...
            for(int cardIterator=0; cardIterator<cardsArray.size(); cardIterator++){
                ...
                switch (reqType) {
                    ...
                    default:
                        it.polimi.ingsw_old.utils.CustomLogger.getLogger().severe("Parser format error");
            ...
            it.polimi.ingsw_old.utils.CustomLogger.getLogger().severe(String.format(("Parser error: %s file not found"), leaderCardsPath));
        }catch (Exception e){
            it.polimi.ingsw_old.utils.CustomLogger.getLogger().severe("General parsing error");
