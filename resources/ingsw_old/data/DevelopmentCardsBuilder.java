...
import it.polimi.ingsw_old.model.card.effect.ProductionEffect;
...
public class DevelopmentCardsBuilder {
    ...
    static private void initBuilder() throws IllegalArgumentException{
        try {
            ...
            it.polimi.ingsw_old.utils.CustomLogger.getLogger().info(String.format(("Starting development cards parsing from file %s"), devCardsPath));
            ...
            it.polimi.ingsw_old.utils.CustomLogger.getLogger().severe(String.format(("Parser error: %s file not found"), devCardsPath));
        }catch (Exception e){
